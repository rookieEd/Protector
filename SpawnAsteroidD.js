...
function Spawn(){
	...
	var position: Vector3 = Vector3(Random.Range(-50,50),0,0);// spawns for bottom of map
	...
	spawnedAsteroid.rigidbody.AddForce(Vector3.forward * movementSpeed);
	spawnAmount ++;
}
...
function SpawnStrong(){
	...
	spawnedSpecialS.rigidbody.AddForce(Vector3.forward * movementSpeed);
	specialSpawnAmount ++;
}