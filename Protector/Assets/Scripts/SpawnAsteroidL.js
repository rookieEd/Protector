...
function Spawn(){
	...
	var position: Vector3 = Vector3(0,0,Random.Range(-50,50));// spawns for left side of map
	...
	spawnedAsteroid.rigidbody.AddForce(Vector3.right * movementSpeed);
	spawnAmount ++;
}
...
function SpawnStrong(){
	...
	spawnedSpecialS.rigidbody.AddForce(Vector3.right * movementSpeed);
	specialSpawnAmount ++;
}