...
function Update () {
	choose = Random.Range(0,2);// picks between 0-1 of which type of asteroid to spawn
...
function Spawn(){
	...
	var position: Vector3 = Vector3(0,0,Random.Range(-50,50));// spawns for right side of map 
	...
	spawnedAsteroid.rigidbody.AddForce(Vector3.left * movementSpeed);
	spawnAmount ++;
}
...
function SpawnStrong(){
	...
	spawnedSpecialS.rigidbody.AddForce(Vector3.left * movementSpeed);
	specialSpawnAmount ++;
}